...
Cosa fa:
Piattaforma di matching two-sided che connette famiglie in cerca di assistenza (anziani, disabilità, babysitting) con operatori della loro zona (OSS, ASA, educatori, babysitter). Il matching avviene sulla piattaforma; il pagamento del servizio resta tra le parti, Mima genera ricavi tramite commissione per lo sblocco del contatto con il candidato scelto.
